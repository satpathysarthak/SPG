...
output_file_est <- str_c("/media/sarthak/gender_prognosis/",args[1],args[2],"_est.tab")
output_file_int <- str_c("/media/sarthak/gender_prognosis/",args[1],args[2],"_int.tab")
#####################
