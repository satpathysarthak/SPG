...
output_file1 <- str_c("/home/workstation/Documents/Sarthak/gender_prognosis/analysis/prognostic/trials/",args[1],"_0_2_SPG_PG_both.tab")
output_file2 <- str_c("/home/workstation/Documents/Sarthak/gender_prognosis/analysis/prognostic/trials/",args[1],"_0_2_SPG_PG_est.tab")
#####################
...
y.train <- as.matrix(Y)
fit <- glmnet(x.train, y.train, family="cox", alpha=0.2)
cv.fit <- cv.glmnet(x.train, y.train, type.measure="deviance",grouped=TRUE,alpha=0.2,family="cox",nfolds=100)
