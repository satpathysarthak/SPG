...
output_dir <- "/home/workstation/Documents/Sarthak/gender_prognosis/analysis/gsea/"
...
for(file_name in dir){
  ...
  id <- subset(id, select = c('gene', "Interaction_coef"))
  ...
  id <- subset(id, select = c('gene_name', 'Interaction_coef'))
  id <- id[order(-id$Interaction_coef),]
